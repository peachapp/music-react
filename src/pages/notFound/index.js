...
const NotFound = () => {
  return <div className="container notfound-container">
    <svg id="robot" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" width="320px" height="300px" viewBox="0 0 160 300" enableBackground="new 0 0 320 300">
      <rect x="59.722" y="72.779" fill="#333" width="40.557" height="27.564" />
      <g id="head" className="up">
        <g id="left-antenna">
          <path fill="none" stroke="#ccc" strokeWidth="1.5" strokeMiterlimit="10" d="M77.519,25.869
        ...
        <g id="right-antenna">
          <path fill="none" stroke="#ccc" strokeWidth="1.5" strokeMiterlimit="10" d="M82.48,25.869
